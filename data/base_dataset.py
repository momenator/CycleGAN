...
def preprocess_numpy_img(numpy_img):
    ...
    processed_img = img.reshape(1, 256, 256)
    processed_img = np.ascontiguousarray(processed_img, dtype=np.float32)
